module IceGauntlet {
  ...
  interface RoomManager {
    ...
    void publishSync(string token, string roomData, string managerId) throws Unauthorized, RoomAlreadyExists, WrongRoomFormat;
    void remove(string token, string roomName) throws Unauthorized, RoomNotExists;
    void removeSync(string roomName, string managerId) throws Unauthorized, RoomNotExists;
